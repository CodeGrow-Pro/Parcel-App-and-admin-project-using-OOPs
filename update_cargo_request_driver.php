                        ...
                        <div class="card">
                           <div class="card-body">
                              <?php 
                                 if(isset($_GET['id']))
                                 {
                                 	$data = $lundry->query("select * from tbl_request_driver where id=".$_GET['id']."")->fetch_assoc();
                                 	?>
                              ...
                              <form method="post" enctype="multipart/form-data">
                                 <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Destination" value="<?php echo $data[''];?>" name="destination" required="">
                                 </div>
                                <div class="form-group">
      ...
      <?php 
        if(isset($_POST['edit_cargoowner']))
        {
          ...
          $target_file2 = $target_dir . basename($newfilename2);
              ...
              $table="tbl_request_driver";
              $field = array('location'=>$cname,'destination'=>$destination,'flammable'=>$idno,'description'=>$desc,'budget'=>$budget,'size'=>$size,'status'=>$okey);
              ...
              <script>
                iziToast.success({
                    title: ' Cargo Section!!',
                    message: 'Request Driver Update Successfully!!',
                    position: 'topRight'
                  });
                      setTimeout(function(){ 
                  window.location.href="list_cargo_request_driver.php"},3000);
              </script>
              <?php 
              }else{ ?>
                   <script>
                iziToast.error({
                    title: ' Cargo Section!!',
                    message: 'Request Driver Update failed!!',
                    position: 'topRight'
                  });
                      setTimeout(function(){ 
                  window.location.href="list_cargo_request_driver.php"},3000);
