                            ...
                            <div class="col-12">
                                <div class="card">
									...
									<table id="datatable" class="table  dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                           <?php 
											 $stmt = $lundry->query("SELECT * FROM `driver_registration`");
$i = 0;
	...
	$i = $i + 1;
											?>
                                               ...
                                               <td> <img src="<?php echo $row['back_img']; ?>" width="60px"></td>
                                                ...
                                                <td> <a href="add_driver_registration_or_update.php?id=<?php echo $row['id']; ?>" class="view">
                                                                    <span class="fa fa-edit btn btn-info"></span></a>
                                                               <?php 
                                                            $tname = 'driver_registration';
                                                            $path = 'list_drive_section_driver';
                                                            ?>
