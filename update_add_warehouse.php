...
<div class="row">
				...
				if(isset($_GET['id']))
				{
					$data = $lundry->query("select * from tbl_add_warehouse where id=".$_GET['id']."")->fetch_assoc();
					?>
					...
					<form method="post" enctype="multipart/form-data">
									   ...
									   <div class="form-group">
                                        ...
                                        <div class="form-group">
											...
											<div class="form-group">
										<img src="https://image.shutterstock.com/image-vector/warehouse-logistic-icon-logo-design-260nw-673131211.jpg" width="100px"/>
										</div>
...
<script>
 iziToast.success({
    ...
    position: 'topRight'
				 ...
				 setTimeout(function(){ 
	 window.location.href="list_add_warehouse.php"},3000);
