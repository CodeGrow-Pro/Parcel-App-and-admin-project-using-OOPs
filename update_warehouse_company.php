...
<div class="row">
				...
				if(isset($_GET['id']))
				{
					$data = $lundry->query("select * from tbl_warehouse_company where id=".$_GET['id']."")->fetch_assoc();
					?>
...
<script>
 iziToast.success({
    ...
    position: 'topRight'
				 ...
				 setTimeout(function(){ 
	 window.location.href="list_warehouse_company.php"},3000);
