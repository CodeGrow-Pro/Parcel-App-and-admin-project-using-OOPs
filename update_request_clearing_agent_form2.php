...
<div class="row">
				...
				if(isset($_GET['id']))
				{
					$data = $lundry->query("select * from tbl_add_clearing_service_location_form2 where id=".$_GET['id']."")->fetch_assoc();
					?>
...
$table="tbl_add_clearing_service_location_form2";
...
<script>
 iziToast.success({
 title: '  Claeing Agent Section!!',
    message: ' service request Update Successfully!!',
    position: 'topRight'
  });
				 setTimeout(function(){ 
	 window.location.href="request_service_list.php"},3000);
