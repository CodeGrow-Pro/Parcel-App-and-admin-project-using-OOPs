                            ...
                            <div class="col-12">
                                <div class="card">
									...
									<table id="datatable" class="table  dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                           <?php 
											 $stmt = $lundry->query("SELECT * FROM `tbl_request_driver`");
$i = 0;
	...
	$i = $i + 1;
											?>
                                               ...
                                               <!--<td> <img src="<?php echo $row['back_img']; ?>" width="60px"></td>-->
                                                ...
                                                <td> <a href="update_cargo_request_driver.php?id=<?php echo $row['id']; ?>" class="view">
                                                                    <span class="fa fa-edit btn btn-info"></span></a>
                                                            
                                                                   <?php 
                                                            $tname = 'tbl_request_driver';
                                                            $path = 'list_cargo_request_driver';
                                                            ?>
